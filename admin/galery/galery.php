...
<body>
	...
	<nav>
        ...
        <ul>
          <li>
            <a href="/wedfix/admin/home-admin.php" >Home</a>
          </li>
          <li>
            <a href="/wedfix/admin/vendor-admin.php">Vendor</a>
          </li>
          <li>
            <a href="#">Review</a>
          </li>
    ...
    <div class="menubar">
        <ul>
            <li>
              <a href="/wedfix/home.php">Home</a>
            </li>
            <li>
              <a href="/wedfix/vendor.php" >Vendor</a>
            </li>
            <li>
              <a href="#">Review</a>
            </li>
            <li>
              <a href="galery/galery.php" class="active">Galery</a>
            </li>
            <li>
              <a href="#">Planning</a>
            </li>
    ...
    <div class="footer-content">
        <div class="footer-section">
            ...
            <p style="color: white;">Jl. Raya Sempidi No.69 Lukluk, Mengwi, Badung, Bali</p>
        </div>
        <div class="footer-section">
            <h3 style="color: white;">Contact Us</h3>
            <p style="color: white;">Phone: +62 853-3777-1403</p>
            <p style="color: white;">Email: info@baliglitzwedding.com</p>
        </div>
        <div class="footer-section">
            <h3 style="color: white;">Follow Us</h3>
            <div style="color: white;" class="social-icons">
                <a href="#" class="social-icon"><i class="fab fa-facebook-f"></i></a>
                <a href="#" class="social-icon"><i class="fab fa-instagram"></i></a>
            </div>
        </div>
    </div>
    <div style="color: white;" class="footer-bottom">
        <p style="color: white;">&copy; 2023 Bali Glitz Wedding. All rights reserved.</p>
    </div>
</footer>
	<!-- Search End -->
